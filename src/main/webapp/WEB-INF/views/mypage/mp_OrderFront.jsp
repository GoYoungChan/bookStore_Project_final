...
<body>
	...
	<div id="full">
		...
		<div>
			<form action="login.mgt" method="post"  name="mypage">
			
				<table border="1" cellpadding="0" cellspacing="0" width="700">
					<tr bgcolor="#3E7C17" align="center" style="color: white; font-style: normal;">
					<th><font size="4"><b>주문일시</b></font></th>
					<th><font size="4"><b>주문번호</b></th> <!-- 클릭시 주문조회 이동 -->
					<th><font size="4"><b>주문상품</b></th>
					<th><font size="4"><b>상품금액</b></th>
					<th><font size="4"><b>상태</th>
				</tr>
				<!--행. 내용들은 기능 연결 전 임시표기  -->
				<tr align="center">	
					<td>2021-11-09</td>
