	...
	<div id="full">
		...
		<div>
			<table border="1" cellpadding="0" cellspacing="0" width="925">
				<tr align="center">
					<th bgcolor="#3E7C17" style="color: white; ">이름</th><td bgcolor="white">${userName}</font></td>
					<th bgcolor="#3E7C17" style="color: white; " width="250">I D</th><td>${userID}</td>
				</tr>
				<tr align="center">
					<th bgcolor="#3E7C17" style="color: white; ">이메일</th><td colspan="3">${userEamil}</td>
				</tr>	
			</table>
		</div>      
		<br>
		...
		<div>
			<form action="insertBoard.mp" method="post">
				<table border="1" cellpadding="0" cellspacing="0" width="700">
					<tr>
						<th bgcolor="#3E7C17" style="color: white; " width="250">제목</th>
						<td>
							<input type="text" name="req_title" cols="110" rows="2" maxlength="30"></textarea>
						</td>
					</tr>
					<tr>
						<th bgcolor="#3E7C17" style="color: white; " width="250">내용</th>
						<td>
							<textarea name="req_content" cols="110" rows="15" maxlength="2000"></textarea>
						</td>
					</tr>
					
					<tr>
						<td colspan="2" style="padding:10px 0 20px 0" align="center">
						<input type="submit" value="보내기" href="insertBoard.mp">&nbsp;&nbsp;
