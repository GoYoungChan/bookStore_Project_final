...
<body>
	<div class="wrapper">
		...
		<div id="full">
				<h1>취소주문내역</h1>
				<h3>${userName}님! 취소주문내역에 오신걸 환영합니다...</h3>  
			<div>
				<h5>
				<p>- 입금확인 이전 취소된 주문인 경우, 고객센터로 결제정보를 알려주셔야만 입금확인 후 환불이 가능합니다.
				</h5>
			</div>
			<hr>
			...
			<div>
				...
				<table border="1" cellpadding="0" cellspacing="0" width="700">
					<tr bgcolor="#3E7C17" style="color: white; ">
						<th>주문일</th><th>주문번호</th><th>주문상품</th><th>조회/취소</th>
					</tr>
					<tr align="center">
						<td>2021-11-09</td><td>100</td><td>명상록</td><td>조회/취소</td>
					</tr>	
				</table>
			</div>
		</div>
