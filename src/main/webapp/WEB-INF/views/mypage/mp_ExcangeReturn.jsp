...
<body>
	...
	<div id="full">
		<div>
			<h1>반품/교환내역 조회</h1>
			<h3>${userName}님! 반품/교환내역 조회에 오신걸 환영합니다...</h3>  
			<h5>
			<p> - 접수하신 반품 혹은 교환(하자상품)내역의 처리상태 및 정보를 조회 변경(취소)할 수 있습니다.<br>
				- 접수내역의 취소 변경(추가)은 현재 처리상태에 따라 불가능 할 수 있습니다.이 경우 (1대1문의하기)를 이용해 신청해 주세요.<br>
				- 반품 환불 : 접수시 선택한 회송방법을 통해 상품이 도착되면 상품취소 및 환불됩니다.<br>
				  반송시(지정택배사 이용시)/쿠폰사용액 차감 후 나머지만 환불되어, 환불예정액과 환불완료액이 다를 수 있습니다.<br>
				- 교환/추가배송/회수 : 교환상품 재배송 편에 하자상품 회수가 이루어집니다.<br>
				- 환불 완료 및 교환상품 출고 완료시 확인 메일을 보내드립니다.
			</p>
			</h5>
		</div>
		<hr>
		...
		<div>
			<table border="1" cellpadding="0" cellspacing="0" width="700">
				<tr bgcolor="#3E7C17" style="color: white; " align="center">
					<th>접수일</th><th>구분</th><th>반품시한</th><th>원주문번호</th><th>상품명/수량</th>
					<th>회송방법</th><th>환불방법</th><th>처리상태</th><th>조회/변경/취소</th>
				</tr>
				<tr align="center">
					<td>2021-11-07</td><td>교환</td><td>2021-11-14</td><td>1007</td><td>1984/1</td>
					<td>택배</td><td>교환</td><td>대기</td><td>조회/변경/취소</td>
				</tr>	
			</table>
		</div>
		<br>
		...
		<div>
			<table border="1" cellpadding="0" cellspacing="0" width="700">
				<tr bgcolor="#3E7C17" style="color: white;" align="center">
					<th>접수일</th><th>구분</th><th>사유</th><th>원주문번호</th><th>상품명/수량</th>
					<th>예상출고일</th><th>예상수령일</th><th>처리상태</th><th>조회/변경/취소</th>
				</tr>
				<tr>
