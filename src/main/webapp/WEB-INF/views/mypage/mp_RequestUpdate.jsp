...
<body>
	...
	<div id="full">
		...
		<div>
			<form action="updateBoardPorc.mp" name="updateForm" onsubmit="" method="get">
				<table border="1" cellpadding="0" cellspacing="0" width="700">
					<tr>
						<th bgcolor="#3E7C17" style="color: white; " width="100">번호</th>
						<td><input type="hidden" name="req_seq" value="${board.req_seq}">${board.req_seq}</td>
					</tr>
					<tr>
						<th bgcolor="#3E7C17" style="color: white; " width="200">제목</th>
						<td><input type="text" name="req_title" value="${board.req_title}"></td>
						
					</tr>
					<tr>
						<th bgcolor="#3E7C17" style="color: white; " width="200">내용</th>
						<td width="auto" height="300"><input type="text" name="req_content" value="${board.req_content}"></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
							<input type="submit" value="수정" onclick="no()">
						</td>
					</tr>	
				</table>
			</form>
