...
<body>
	<div class="wrapper">
		...
		<!-- header 끝 -->
		<table cellspacing="0" cellpadding="0" border="0" align="center" style="width: auto; height: auto; margin-bottom: 20px">
			<tr>
				<td colspan=2>
					<p align="center">
					<form action="deleteUser.mgt?bs_id=${userID}" method="post">
						<table border="0" width="380" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center" colspan="2" bgcolor="#3E7C17" style="color: white;">
									<font size="4"><b>회원 탈퇴</b></font>
								</td>
							</tr>
							<tr>
								<td bgcolor="#F5F5F5" align="center" height="35" width="125">
								<font size="2">비밀번호</font></td>
								<td bgcolor="#F5F5F5">
								<input type="password" name="bs_pass" />
								</td>
							</tr>
							<tr>
								<td bgcolor="#F5F5F5" align="center" colspan="2" height="35">
									<input type="submit" value="탈 퇴" />&nbsp;&nbsp;
									<a href="login.mgt"><input type="button" value="취 소" /></a>
								</td>
							</tr>				
						</table>
					</form>				
